...
export function getExchangeRateRecordFromJSONResponse(
  json: object,
  ...
  var exchangeRates: Record<CurrencyType, number> = {
    ...
    [CurrencyType.INR]: 0,
    [CurrencyType.HKD]: 0,
    [CurrencyType.OTHER]: customCurrency.rate,
  };
...
export const languageLabels = [
  {
    ...
    label: "enum.language_english",
    iconUrl: new URL("../img/flag-uk.svg", import.meta.url).toString(),
  },
  {
...
export const currencySymbols = [
  ...
  { value: CurrencyType.OTHER, symbol: customCurrency.symbol },
];
